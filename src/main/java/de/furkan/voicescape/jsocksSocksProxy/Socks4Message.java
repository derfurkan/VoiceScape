...
class Socks4Message extends ProxyMessage {
     ...
     * Client request
     */
    public Socks4Message(final int cmd, final InetAddress ip, final int port, final String user) {
    ...
    public Socks4Message(
            final int version, final int cmd, final InetAddress ip, final int port, final String user) {
    ...
    /**
     * Initialise from the stream If clientMode is true attempts to read a server response otherwise
     * reads a client request see read for more detail
     */
    public Socks4Message(final InputStream in, final boolean clientMode) throws IOException {
        msgBytes = null;
        read(in, clientMode);
    }
    ...
    public void read(final InputStream in, final boolean clientMode) throws IOException {

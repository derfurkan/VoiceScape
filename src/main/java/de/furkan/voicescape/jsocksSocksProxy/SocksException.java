...
/**
 * Exception thrown by various socks classes to indicate errors with protocol or unsuccessfull
 * server responses.
 */
public class SocksException extends java.io.IOException {
     ...
     *
     * <p>Tries to look up message which corresponds to this error code.
     *
    ...
    public void lookupErrorString(int errCode) {
        if ((errCode >> 16) == 0) {

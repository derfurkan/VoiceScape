...
public class VoiceScapePlugin extends Plugin {
    ...
    public static String uuidString = generateUUID(16);
    ...
    private static String generateUUID(int lenght) {
    ...
    public void onConfigChanged(final ConfigChanged configChanged) {
        ...
        if (configChanged.getKey().equals("usecustomserver")) {
            ...
            JOptionPane.showMessageDialog(
                    null,
                    "To apply this setting you will be reconected to the server.",
